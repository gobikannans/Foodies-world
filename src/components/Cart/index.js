  ...
  render() {
    ...
    <AppTheme.Consumer>
      {value=>{
        ...
        const cartContainerBg=activeTheme==="light"? "#f9fbfe":"#313131"
        const cartItemHeading = activeTheme === 'light' ? "#64748b":"#94a3b8"
        const orderHeading = activeTheme === 'light' ? ' #183b56' : '#ffa412'
        const paymentHeading = activeTheme === 'light' ? ' #183b56' : '#f1f1f1'


      const renderCartLoader = () => (
          <div className="cart-loader-container">
            <TailSpin type="ThreeDots" color="#F7931E" height="50" width="50" />
          </div>
        )
      ...
      const  renderPaymentSuccessView = () => (
          <div className="no-order-container">
            ...
            <h1 className="payment-heading" style={{color:`${paymentHeading}`}}>Payment Successful</h1>
            <p className="no-order-para">
              Thank you for ordering <br />
              Your payment is successfully completed.
            </p>
            <Link to="/" className="cart-links">
              <button type="button" className="pay-btn" onClick={onClickToHome}>
                Go To Home Page
              </button>
            </Link>
          </div>
      ...
      const  renderEmptyCartView = () => (
          <div className="no-order-container">
            ...
            />
            <h1 className="no-order-heading" style={{color:`${paymentHeading}`}} >No Order Yet!</h1>
            <p className="no-order-para">
       ...
       const renderCartItems = () => {
          ...
          return (
            <div className="cart-container" style={{backgroundColor:`${cartContainerBg}`}}>
              <div className="cart-heading-container">
                <p className="cart-heading" style={{color:`${cartItemHeading}`}}>Item</p>
                <p className="cart-heading" style={{color:`${cartItemHeading}`}}>Quantity</p>
                <p className="cart-heading" style={{color:`${cartItemHeading}`}}>Price</p>
              </div>
              ...
              <div className="order-container">
                <h1 className="order-style"  style={{color:`${orderHeading}`}} >Order Total:</h1>
                <div className="cart-sum">
                  <p className="order-style" style={{color:`${orderHeading}`}}>
                    <span>
      ...
      const  renderCartApiStatus = () => {
        ...
        return(
          <div className="cart-bg-container"  style={{backgroundColor:`${cartBg}`}}>{renderCartApiStatus()}</div>
