    ...
    <AppTheme.Consumer>
      {value=>{
        ...
        <li className="cart-list-items">
          ...
          <h1 className="cart-item-name-lg" style={{color:`${cartItemHeading}`}}>{name}</h1>
          </div>
          <div className="small-cart-container">  
          <h1 className="cart-item-name-sm" style={{color:`${cartItemHeading}`}}>{name}</h1>
            ...
            <div className="cart-btn-container">
              ...
              <p className="add-item-text" style={{color:`${cartItemHeading}`}}>{quantity}</p>
              <button
                type="button"
