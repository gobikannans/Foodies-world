        ...
        const itemPara = activeTheme === 'light' ? "#64748b":"#94a3b8"
          ...
          return(
            ...
            <div className="page-container">
              <button type="button" className="page-btn" onClick={this.onDecrement} style={{color: `${itemPara}`}}>
              ...
              <button type="button" className="page-btn" onClick={this.onIncrement} style={{color: `${itemPara}`}}>
