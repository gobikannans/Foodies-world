...
class Home extends Component {
  ...
  renderHomeBannerLoader = () => (
    <div className="loader-banner-container">
      <TailSpin type="TailSpin" color="#F7931E" height="50" width="50" />
    </div>
  )
    ...
    return (
      <AppTheme.Consumer>
        ...
        const renderRestaurantApiStatus = () => {
          ...
          return(
            <div className="home-bg-container" style={{backgroundColor:`${homeBg}`}}>
        <div className="banner-container">{this.renderBannerApiStatus()}</div>
        <div className="home-container">
          <h1 className="home-heading" style={{color: `${homeHeading}`}} >Popular Restaurants</h1>
          ...
          <div className="search-sort-container">
            ...
            <div className="sort-by-container">
              <MdSort color="#475569" className="sort-icon" style={{color: `${homePara}`}} />
              <p className="sort-by-text" style={{color: `${homePara}`}}>Sort by </p>
              <select
              ...
              >
                {sortByOptions.map(eachSort => (
                  <option style={{color: `${homePara}`}} key={eachSort.id}>{eachSort.displayText}</option>
                ))}
              </select>
            </div>
          </div>
