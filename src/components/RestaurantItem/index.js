          ...
          <Link to={`/restaurant/${id}`} className="restaurant-links">
            <li className="restaurant-list-item">
              ...
              <div className="restaurant-list-details">
                <h1 className="restaurant-heading" style={{color: `${itemHeading}`}}>{name}</h1>
                <p className="restaurant-cuisine" style={{color: `${itemPara}`}}>{cuisine}</p>
                <div className="rating-container">
                  <AiFillStar color="#FFCC00" />
                  <p className="rating" style={{color: `${itemPara}`}}>{rating}</p>
